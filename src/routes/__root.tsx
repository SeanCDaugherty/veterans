  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#0d1210" },
      {
        name: "description",
        content:
          "Rally Point — a customizable home base for combat veterans. Crisis tools, claims, breathing, and civilian transition. Data stays on your device.",
      },
    ],
    links: [
